...
/*-----------------------------------------------------------------------------------------------*/
PompeiEruption::PompeiEruption (const ekat::Comm& comm, const ekat::ParameterList& params)
 : AtmosphereProcess(comm,params)
{
  // The 'params' variable will hold all runtime options.  In this case we retrieve the parameter
  // "eruption_date" from the parameter list and assign it to a time stamp object.
...
set_grids (const std::shared_ptr<const GridsManager> grids_manager)
{
  ...
  // Declare the field "ash" which will be updated each time step by this process.
